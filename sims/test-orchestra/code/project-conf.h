...
#define CUSTOM_TSCH_HOPPING_SEQUENCE_5_5_MED (uint8_t[]){17, 18, 19, 20, 21}
#define CUSTOM_TSCH_HOPPING_SEQUENCE_3_3_MED (uint8_t[]){19, 20, 21}
#define CUSTOM_TSCH_HOPPING_SEQUENCE_4_4_BEST_STRASBOURG (uint8_t[]){14, 15, 16, 17}
#define CUSTOM_TSCH_HOPPING_SEQUENCE_3_3_BEST_STRASBOURG (uint8_t[]){14, 15, 17}
#define CUSTOM_TSCH_HOPPING_SEQUENCE_2_2_BEST_STRASBOURG (uint8_t[]){14, 15}
...
#define TSCH_CONF_DEFAULT_HOPPING_SEQUENCE    CUSTOM_TSCH_HOPPING_SEQUENCE_3_3_MED
#endif
